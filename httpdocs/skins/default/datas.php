...
$level_points = "puntos de experiencia";
...
//CABEZA
$items[25] = array ("id" => 25, "name" => "Diadema del &Aacute;guila", "bonus" => "+1|car", "gold" => 250, "slot" => "Cabeza");
...
//CUELLO
$items[26] = array ("id" => 26, "name" => "Colgante de Zarpa de Oso", "bonus" => "+1|fue", "gold" => 250, "slot" => "Cuello");
...
$items[27] = array ("id" => 27, "name" => "Sobretodo del Guerrero", "bonus" => "+1|fue", "gold" => 250, "slot" => "Espalda");
//MANOS
...
//CINTURA
$items[28] = array ("id" => 28, "name" => "Cinto espejado", "bonus" => "+1|car", "gold" => 250, "slot" => "Cintura");
...
$items[29] = array ("id" => 29, "name" => "Zapatos brillantes", "bonus" => "+1|car", "gold" => 250, "slot" => "Piernas");
