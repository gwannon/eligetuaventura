...
<head>
	...
	<link href="http://cdn.tapquo.com/lungo/startup-image-1496x2048.png" media="(device-width: 768px) and (device-height: 1024px)
	     ...
	     and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image">
	*}
	<link rel="shortcut icon" type="image/ico" href="/skins/{$Skin}/icon_16x16.png" />
	<!-- Main Stylesheet -->
	...
	<link rel="stylesheet" href="/components/lungo/lungo.css">
	<link rel="stylesheet" href="/skins/{$Skin}/theme.css">
	<script type="text/javascript">
		var _gaq = _gaq || [];
		_gaq.push(['_setAccount', 'UA-188854-18']);
	...
	<audio autoplay loop>
		<source src="/skins/{$Skin}/music/02-RogerSubirana-PointOfNoReturn2008-PointOfNoReturn.mp3">
	</audio>
